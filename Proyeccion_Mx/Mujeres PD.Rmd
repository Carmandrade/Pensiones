...
poblacion_activo_inv_vejez<-poblacion_f[21:116,-c(1,2,4)]

poblacion_inicial_f<- cbind(poblacion_activo_inv_vejez, poblacion[21:116,4])

colnames(poblacion_inicial_f)<- c("activo", "invalidez", "vejez", "sucesion", "muerte")

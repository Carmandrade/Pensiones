...
poblacion_activo_inv_vejez<-poblacion[21:116,-c(1,2,4)]
...
# Conteo de cotizaciones y salarios
...
### Separacion de la base activos en hom y muj para cotizaciones
...
### Separacion de la base activos en hom y muj para salarios
```{r, separacion de base por sexo}
...
### Vector densidad de cotizacion anual por edad 
```{r}
...
### Vector salario anual promedio por edad mujeres
```{r}
...
### Matriz cot acumuladas por edad mujeres
```{r}
...
### Vector de cotizaciones acumuladas por edad 
```{r}
# Clean column names
...
for (s in 1:100) {
  ...
  for (j in 21:114) {
      ...
      matrizFinal_Estoca_9f <-  matrizFinal_Estoca_9f + matriz_esto_2   # suma las matrices
